 ...
 *
 * ⚠️ و پیامدش را باید صریح گفت: چون در `Inventory` نیست، **از صندوق
 *    فروخته نمی‌شود**.  این محدودیتِ شناخته‌شدهٔ این مرحله است، نه
 *    فراموشی؛ فروشِ امانیِ گرفته‌شده از راهِ صندوق کارِ جداگانه‌ای
 *    می‌خواهد که ارزش‌گذاریِ موجودی را هم دست بزند.
 */
