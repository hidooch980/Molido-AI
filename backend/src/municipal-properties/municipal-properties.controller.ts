...
@ApiTags('املاک شهرداری')
@ApiBearerAuth()
@UseGuards(JwtAuthGuard, RolesGuard)
@Controller('municipal-properties')
export class MunicipalPropertiesController {
  constructor(private readonly service: MunicipalPropertiesService) {}
