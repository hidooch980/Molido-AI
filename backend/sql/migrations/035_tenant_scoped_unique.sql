...
--
-- ⚠️ جدول‌هایی که `companyId` ندارند دست نمی‌خورند.
--
-- ⚠️ این نسخه سه قید هویتی را اشتباهاً در دام انداخت؛ مهاجرت ۰۳۶
--    برشان می‌گرداند.  چون فایل اجراشده ویرایش نمی‌شود، متن اینجا
--    دست‌نخورده می‌ماند و اصلاح در فایل بعدی است.
-- =============================================
