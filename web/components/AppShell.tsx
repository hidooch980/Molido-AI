...
export const NAV: NavItem[] = [
  ...
  { href: '/records/parking', group: 'records', label: 'menuParking', icon: 'building' },
  { href: '/records/street-lights', group: 'records', label: 'menuStreetLights', icon: 'tag' },
  { href: '/records/crisis', group: 'records', label: 'menuCrisis', icon: 'alert' },
  { href: '/records/fleet', group: 'records', label: 'menuFleet', icon: 'truck' },
  { href: '/records/taxi', group: 'records', label: 'menuTaxi', icon: 'truck' },
  { href: '/records/iot', group: 'records', label: 'menuIot', icon: 'target' },
  { href: '/records/letters', group: 'records', label: 'menuLetters', icon: 'news' },
  { href: '/records/municipal-properties', group: 'records', label: 'menuMunicipalProps', icon: 'building' },
  { href: '/records/service-zones', group: 'records', label: 'menuServiceZones', icon: 'target' },
  { href: '/records/property-audit', group: 'records', label: 'menuPropertyAudit', icon: 'survey' },
