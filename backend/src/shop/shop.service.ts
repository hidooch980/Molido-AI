...
export class ShopService {
   ...
   *
   * عمرش عمداً بلند است: مشتری هفته‌ای یک بار سر می‌زند و ورود دوباره در
   * هر بازدید، سبد و تجربهٔ خرید را خراب می‌کند.
   *
   * ⚠️ توکنِ کارمند از این **بسیار** کوتاه‌تر است (دو ساعت) — این دو
   *    عمداً فرق دارند، نه از روی بی‌دقتی.  کارمند به کلِ سامانه دسترسی
   *    دارد؛ مشتری فقط به سفارش‌ها و سبدِ خودش.
   *
   *    و بلندیِ این توکن فقط وقتی قابل قبول است که `CustomerAuthGuard`
